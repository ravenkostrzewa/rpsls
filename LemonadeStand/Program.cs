...
namespace RPSLS
{
    class Game
    {
        ...
        public void SetUpPlayers()
        {
            ...
            Console.WriteLine("Would you like to play against yourself, with a friend,  or against the computer. Enter 1 to play against yourself, enter 2 to play agains a friendthe con[i);
